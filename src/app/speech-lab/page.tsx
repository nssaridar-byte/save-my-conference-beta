        ...
        >
          {selectedSpeech ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center gap-4 py-20">
              ...
              <div>
                <h3 className="text-xl font-geist font-semibold">No Speech Selected</h3>
                <p className="text-muted-foreground">Select a speech from the sidebar or create a new one to start editing.</p>
              </div>
